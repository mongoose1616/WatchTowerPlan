...
## Description
`This directory holds machine-readable acceptance contracts derived from durable PRD acceptance criteria. Use it when workflows or Python helpers need a deterministic acceptance surface without parsing PRD prose directly.`
