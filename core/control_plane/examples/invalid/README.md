# `core/control_plane/examples/invalid`

## Description
`This directory holds canonical counterexamples that are expected to fail validation and help exercise error handling.`
...
| `core/control_plane/examples/invalid/interfaces/` | Invalid examples for generic pack-facing interface validation. |
