...
## Description
`This directory holds committed durable validation-evidence artifacts. Use it for reviewable validation outcomes tied to traced initiatives, not for transient runtime logs or mutable execution output.`
...
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase3_command_companion_source_surface_normalization.v1.json` | Validation evidence for the completed first bounded Phase 3 command companion source-surface normalization slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase3_command_companion_source_surface_normalization_ready.v1.json` | Validation evidence for the approved Phase 3 entry outcome and the first bounded command companion source-surface normalization slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_shared_projection_entry_ready.v1.json` | Validation evidence for the closed Phase 3 outcome review and the bounded Phase 4 shared-projection entry checkpoint. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_planning_projection_snapshot_ready.v1.json` | Validation evidence for the approved Phase 4 entry outcome and the first bounded planning projection snapshot slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_planning_projection_snapshot.v1.json` | Validation evidence for the completed first bounded Phase 4 planning projection snapshot slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_coordination_entry_ready.v1.json` | Validation evidence for the closed first Phase 4 slice outcome review and the bounded closeout-coordination entry checkpoint. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_coordination_sync_reuse_ready.v1.json` | Validation evidence for the approved closeout-coordination entry review and the bounded post-traceability coordination-sync reuse slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_coordination_sync_reuse.v1.json` | Validation evidence for the completed bounded Phase 4 closeout coordination sync-reuse slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_tracking_entry_ready.v1.json` | Validation evidence for the closed closeout coordination sync-reuse outcome review and the bounded closeout-tracking entry checkpoint. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_tracking_refresh_boundary_ready.v1.json` | Validation evidence for the approved closeout-tracking entry review and the bounded private closeout-local tracker refresh boundary slice. |
| `core/control_plane/ledgers/validation_evidence/structural_rewrite_phase4_closeout_tracking_refresh_boundary.v1.json` | Validation evidence for the completed bounded Phase 4 closeout-tracking refresh-boundary slice. |
