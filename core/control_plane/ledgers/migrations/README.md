...
| `core/control_plane/ledgers/migrations/structural_rewrite_phase4_closeout_tracking_entry_ready.v1.json` | Migration record for the closed closeout coordination sync-reuse outcome review that opens the bounded closeout-tracking entry checkpoint. |
| `core/control_plane/ledgers/migrations/structural_rewrite_phase4_closeout_tracking_refresh_boundary_ready.v1.json` | Migration record for the approved closeout-tracking entry review that opens the bounded private closeout-local tracker refresh boundary slice. |
| `core/control_plane/ledgers/migrations/structural_rewrite_phase4_closeout_tracking_refresh_boundary.v1.json` | Migration record for the completed bounded Phase 4 closeout-tracking refresh-boundary slice. |
