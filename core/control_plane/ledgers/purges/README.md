...
## Description
`This directory holds the minimal surviving ledger entries for traced planning packages that were explicitly purged from the repository after retention checks passed.`
