...
## Description
`This directory holds published validation interfaces for external content. Use it to describe what core accepts, not to store external artifacts themselves.`
