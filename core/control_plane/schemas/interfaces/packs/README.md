...
## Description
`This directory holds generic pack-facing interface schemas for future domain packs. Use these schemas for pack settings, governed surface maps, indexes, notes, and extraction outputs without storing pack-owned artifacts in core.`
...
| `core/control_plane/schemas/interfaces/packs/artifact_index.schema.json` | Schema for one future pack artifact index. |
