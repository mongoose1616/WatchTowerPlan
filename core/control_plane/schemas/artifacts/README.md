...
- This directory carries the active control-plane artifact schemas plus the current migration, purge, and evidence record schemas consumed by the internal planning-and-implementation pack.
