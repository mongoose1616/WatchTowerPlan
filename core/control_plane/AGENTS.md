...
- Use [ROUTING_TABLE.md](/plan/workflows/ROUTING_TABLE.md) only when a plan-domain route explicitly depends on shared control-plane artifact updates.
...
- Do not move pack-owned live state out of `plan/.wt/**` into this tree.
