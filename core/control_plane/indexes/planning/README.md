...
| `core/control_plane/indexes/planning/planning_catalog.json` | Canonical machine-readable planning catalog for deep trace-linked planning lookup with explicit status semantics. |
...
- Keep the initiative and coordination indexes aligned as narrower rendered surfaces rather than competing authorities.
