...
| `core/control_plane/indexes/workflows/workflow_index.json` | Canonical machine-readable workflow index rebuilt from `core/workflows/modules/**` and `plan/workflows/modules/**`. |
