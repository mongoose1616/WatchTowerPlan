...
- Retained benchmark environment context should remain portable and must not embed machine-local absolute interpreter paths.
...
| `core/control_plane/records/benchmarks/benchmark_core_cli_representative_v1_20260329_baseline.json` | Baseline retained benchmark record for the governed reusable-core CLI representative suite captured on `2026-03-30T18:32:25Z`. |
