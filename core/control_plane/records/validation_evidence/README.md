...
| `core/control_plane/records/validation_evidence/governed_acceptance_example_validation_baseline.json` | Durable generic validation-evidence example paired with the governed acceptance contract example. |
