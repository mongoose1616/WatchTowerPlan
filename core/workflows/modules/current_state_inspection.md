...
1. Identify the current surfaces in scope.
   ...
   - When the work belongs to an existing planning trace, start with `plan/tracking/initiative_tracking.md` or the initiative index before fanning out into PRD, design, decision, or task family surfaces.
