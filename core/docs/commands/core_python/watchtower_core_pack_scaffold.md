...
- Renders starter routing guidance with canonical machine workflow paths such as `core/workflows/modules/core.md` so copied-core route indexing stays valid across donor and recipient repositories.
