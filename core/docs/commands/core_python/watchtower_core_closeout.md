...
## Summary
This command group closes live initiative packages under `plan/**`, provides the retained
trace closeout path for already-promoted historical records, and provides the governed purge
path for eligible closed trace packages.
