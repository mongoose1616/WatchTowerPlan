...
| `watchtower-core plan sync initiative-index` | Rebuilds one of the initiative coordination surfaces that retained or plan closeout also updates in write mode. |
