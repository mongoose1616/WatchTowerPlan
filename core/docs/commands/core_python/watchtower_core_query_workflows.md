...
```sh
cd core/python
uv run watchtower-core query workflows --related-path core/docs/templates/foundation_document_template.md
```

```sh
cd core/python
uv run watchtower-core query workflows --reference-path core/docs/references/github_collaboration_reference.md --format json
```
