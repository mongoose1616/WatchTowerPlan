...
- Repository-bundle mode may legitimately leave `core/control_plane/indexes/traceability/traceability_index.json` with `entries: []` when the export contains no portable shared trace lineage after the acceptance/evidence scrub.
