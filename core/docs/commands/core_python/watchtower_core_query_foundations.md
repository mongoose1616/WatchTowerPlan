...
## Use When
- You need to know which foundation document governs a repo surface such as `core/python/`, `core/workflows/modules/`, `core/workflows/roles/`, or an owning pack workflow root.
