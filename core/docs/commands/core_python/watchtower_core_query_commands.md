...
| Source Surface | `core/python/src/watchtower_host/cli/query_discovery_family.py` |
...
| `core/docs/commands/core_python/README.md` | Human-readable command-family inventory for the current workspace. |
