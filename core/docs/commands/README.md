...
## Boundaries
`Keep one command or subcommand per page. Keep external command references in core/docs/references/ and keep machine-readable command lookup data under core/control_plane/indexes/commands/.`
