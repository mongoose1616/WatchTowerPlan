...
## Description
`This directory is the durable home for core-only guidance, references, standards, and other human-authored material that should not live in the live plan workspace.`
