...
- Pair it with [pep257_reference.md](/core/docs/references/pep257_reference.md) for the baseline docstring expectations that apply before section style choices.
- If Google-style docstrings become the required local format, codify that rule under `core/docs/standards/engineering/**` rather than leaving it only here.
