...
- If the repo adopts explicit local deviations from PEP 8, define them under `core/docs/standards/engineering/**` rather than hiding them in ad hoc code review comments.
