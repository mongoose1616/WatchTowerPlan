...
- Repository-front-matter policy now lives in [front_matter_standard.md](/core/docs/standards/metadata/front_matter_standard.md), while this reference remains the supporting working reference.
...
- [front_matter_standard.md](/core/docs/standards/metadata/front_matter_standard.md) is now the authority for repository front matter policy.
