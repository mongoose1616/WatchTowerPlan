...
- Local repository policy now splits shared pack-neutral tests under `core/python/tests/` from pack-owned direct-runtime tests under owning pack roots such as `<pack-root>/python/tests/`.
