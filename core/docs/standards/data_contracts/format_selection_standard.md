...
- [rfc_8259_json_reference.md](/core/docs/references/rfc_8259_json_reference.md): local reference surface for the external or canonical guidance this standard depends on.
- [yaml_1_2_2_reference.md](/core/docs/references/yaml_1_2_2_reference.md): local reference surface for the external or canonical guidance this standard depends on.
- [ndjson_spec_reference.md](/core/docs/references/ndjson_spec_reference.md): local reference surface for the external or canonical guidance this standard depends on.
- [sqlite_wal_reference.md](/core/docs/references/sqlite_wal_reference.md): local reference surface for the external or canonical guidance this standard depends on.
- [commonmark_reference.md](/core/docs/references/commonmark_reference.md): local reference surface for the external or canonical guidance this standard depends on.
...
- [rfc_8259_json_reference.md](/core/docs/references/rfc_8259_json_reference.md)
- [yaml_1_2_2_reference.md](/core/docs/references/yaml_1_2_2_reference.md)
- [ndjson_spec_reference.md](/core/docs/references/ndjson_spec_reference.md)
- [sqlite_wal_reference.md](/core/docs/references/sqlite_wal_reference.md)
