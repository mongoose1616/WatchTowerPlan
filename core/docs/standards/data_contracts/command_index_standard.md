...
- [command_md_standard.md](/core/docs/standards/documentation/command_md_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
...
- [schema_catalog_standard.md](/core/docs/standards/data_contracts/schema_catalog_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
...
- [README.md](/core/control_plane/indexes/commands/README.md): family entrypoint and inventory surface this standard should stay aligned with.
...
## References
- [command_md_standard.md](/core/docs/standards/documentation/command_md_standard.md)
...
- [README.md](/core/control_plane/indexes/commands/README.md)
