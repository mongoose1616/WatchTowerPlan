...
- `Operational Surfaces`: `plan/python/src/watchtower_plan/sync/standard_index.py`; `plan/python/src/watchtower_plan/query/standards.py`; `core/control_plane/indexes/standards/`; `core/control_plane/schemas/artifacts/`
