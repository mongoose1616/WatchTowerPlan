...
- [rfc_9562_uuid_reference.md](/core/docs/references/rfc_9562_uuid_reference.md): local reference surface for the external or canonical guidance this standard depends on.
- [semver_reference.md](/core/docs/references/semver_reference.md): local reference surface for the external or canonical guidance this standard depends on.
...
- `Operational Surfaces`: `core/control_plane/schemas/`; `core/control_plane/indexes/`; `core/control_plane/contracts/`; `core/docs/templates/pack/`
...
- [rfc_9562_uuid_reference.md](/core/docs/references/rfc_9562_uuid_reference.md)
