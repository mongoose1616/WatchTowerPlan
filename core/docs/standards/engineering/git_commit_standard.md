...
- Does not define branch naming or local branch lifecycle policy. Those rules live in [git_workflow_standard.md](/core/docs/standards/engineering/git_workflow_standard.md).
