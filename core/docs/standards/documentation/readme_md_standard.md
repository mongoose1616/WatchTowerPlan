...
- [readme_template.md](/core/docs/templates/readme_template.md): authoring scaffold that should stay aligned with this standard.
...
## Operationalization
- `Modes`: `documentation`
- `Operational Surfaces`: `README.md`; `**/README.md`; `core/docs/templates/readme_template.md`
