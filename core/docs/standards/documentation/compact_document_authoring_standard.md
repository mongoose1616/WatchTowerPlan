...
## Summary
This standard defines the repository rule that authored human-readable documents should include the sections, tables, and historical detail humans need to review the repository effectively without normalizing low-value boilerplate.
...
- Generated human-readable trackers should prefer dense tables, clear headings, and focused zero-state text over placeholder `None` rows or repeated footer prose.
