...
- [routing_table_template.md](/core/docs/templates/routing_table_template.md): authoring scaffold that should stay aligned with this standard.
...
- [routing_table_template.md](/core/docs/templates/routing_table_template.md)
