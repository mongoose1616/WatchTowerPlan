...
- [cli_help_text_standard.md](/core/docs/standards/engineering/cli_help_text_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
...
- [command_reference_template.md](/core/docs/templates/command_reference_template.md): authoring scaffold that should stay aligned with this standard.
...
- [command_reference_template.md](/core/docs/templates/command_reference_template.md)
- [README.md](/core/docs/commands/README.md)
