...
- `Operational Surfaces`: `*/docs/standards/*/*_standard.md`; `core/python/src/watchtower_core/sync/standard_index.py`; `core/python/src/watchtower_core/query/standards.py`; `core/docs/commands/core_python/watchtower_core_query_standards.md`; `core/docs/templates/standard_document_template.md`
...
## References
- [standard_document_template.md](/core/docs/templates/standard_document_template.md)
