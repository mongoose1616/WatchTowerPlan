...
- `Operational Surfaces`: `plan/python/src/watchtower_plan/markdown_semantics.py`; `plan/python/src/watchtower_plan/governed_documents.py`; `plan/python/src/watchtower_plan/sync/workflow_index.py`; `plan/python/src/watchtower_plan/validation/document_semantics.py`; `core/docs/commands/core_python/watchtower_core_validate_document_semantics.md`; `core/docs/commands/core_python/watchtower_core_validate_all.md`; `core/control_plane/registries/validator_registry.json`
