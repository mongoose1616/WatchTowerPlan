...
- Keep authored schemas, registries, contracts, policies, and indexes in [core/control_plane](/core/control_plane), and keep live plan machine state in `plan/.wt/**` rather than in the Python workspace.
...
- Push generic loaders, validators, adapters, and utility logic back into reusable-core packages when they stop being plan-specific.
