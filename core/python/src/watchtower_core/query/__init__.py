...
_EXPORT_MODULES = {
    ...
    "BenchmarkRecordQueryService": "watchtower_core.query.benchmarks",
    "BenchmarkRecordSearchParams": "watchtower_core.query.benchmarks",
    ...
    "TemplateCatalogQueryService": "watchtower_core.query.templates",
    "TemplateCatalogSearchParams": "watchtower_core.query.templates",
