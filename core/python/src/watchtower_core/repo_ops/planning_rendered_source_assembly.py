"""Private helpers for assembling trace-scoped planning rendered sources."""
...
class TracePlanningRenderedSourceAssembly:
    """Trace-linked planning sources grouped once for downstream rendered surfaces."""
...
def build_trace_planning_rendered_source_assembly(
    loader: ControlPlaneLoader,
) -> TracePlanningRenderedSourceAssembly:
    """Load and group planning sources once per sync or query pass."""

    return TracePlanningRenderedSourceAssembly(
