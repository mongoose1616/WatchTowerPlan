    ...
    def _build_entry(
        ...
        *,
        ...
        entry: dict[str, object] = {
            ...
            "created_at": _artifact_created_at(document),
            "updated_at": _artifact_updated_at(document),
...
def _artifact_created_at(document: dict[str, object]) -> str:
    return (
...
def _artifact_updated_at(document: dict[str, object]) -> str:
    return (
