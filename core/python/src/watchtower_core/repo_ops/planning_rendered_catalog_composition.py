"""Private helpers for composing planning catalog entries from one rendered snapshot."""
...
class TracePlanningCatalogAggregation:
    """Catalog-only aggregated metadata derived from one planning rendered snapshot."""
