...
## Summary
Export-safe validation services, suite orchestration, aggregate baseline helpers, result models, and namespace guardrails that keep plan-domain semantic rule providers under `watchtower_plan.validation`.
