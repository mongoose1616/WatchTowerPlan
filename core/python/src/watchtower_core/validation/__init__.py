...
_EXPORT_MODULES = {
    ...
    "PortabilityValidationService": "watchtower_core.validation.portability",
    "SchemaDefinitionValidationService": "watchtower_core.validation.schema_definition",
...
__getattr__ = lazy_module_getattr(
    ...
    blocked_messages=(
        dict.fromkeys(
            ...
            "Import pack-local document semantics from the owning "
            "watchtower_<pack>.validation package.",
        )
        | dict.fromkeys(
            _SUBMODULE_ONLY_EXPORTS,
