...
| Path | Description |
|---|---|
| `core/README.md` | Describes the purpose of the core directory and its current boundaries. |
| `core/control_plane/` | Holds the versioned control-plane artifact tree. |
| `core/python/` | Holds the consolidated Python workspace for the helper and harness layer. |
