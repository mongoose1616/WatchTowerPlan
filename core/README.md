...
- Treat `core/docs/**`, `core/workflows/**`, and the shared control-plane surfaces as the authored source for reusable guidance. When a hosted pack exposes a reusable docs or instruction gap, strengthen the shared-core surface first before adding a pack-local overlay.
