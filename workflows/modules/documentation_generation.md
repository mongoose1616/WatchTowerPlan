...
- Existing source material needs to be converted into a repository-native document.
- A new directory or document set needs an initial README or supporting documentation.
- A planning, standards, or reference gap has been identified and a new document must be created rather than refreshed.

## Inputs
- Scoped documentation-generation brief
- Documentation request or target topic
