...
- [task_lifecycle_management.md](/workflows/modules/task_lifecycle_management.md): source task updates and successor-task creation should stay aligned with the repository's normal task lifecycle rules.
