...
51. `Q51=10` `clean core-versus-plan python split`
    Reusable shared-core Python stays under `watchtower_core`, while plan-domain runtime lives under the approved plan-owned boundary at `plan/python/src/watchtower_plan/`.
