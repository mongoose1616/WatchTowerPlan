...
summary: "Explains the repository-wide standards posture, authority model, and why governed standards matter."
type: "foundation"
status: "active"
tags:
  - "foundation"
...
Standards in this repository exist to protect coherence in an LLM- and agent-driven system. They are not decoration and they are not optional cleanup work. The point is to keep repository scope, machine state, workflows, human-readable outputs, and evidence aligned so the system remains trustworthy as it grows.
