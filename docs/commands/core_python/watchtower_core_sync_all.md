...
- The current target set includes command, foundation, reference, standard, workflow, PRD, decision, design, task, traceability, and repository-path indexes, plus the PRD, decision, design, and task trackers.
