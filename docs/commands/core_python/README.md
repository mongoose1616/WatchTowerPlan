...
| Path | Description |
|---|---|
| `docs/commands/core_python/README.md` | Describes the purpose of the core Python command-doc directory and its current pages. |
| `docs/commands/core_python/watchtower_core_closeout.md` | Human-readable command page for the watchtower-core closeout command group. |
| `docs/commands/core_python/watchtower_core_closeout_initiative.md` | Human-readable command page for the watchtower-core closeout initiative command. |
| `docs/commands/core_python/watchtower_core.md` | Human-readable command page for the root watchtower-core command. |
| `docs/commands/core_python/watchtower_core_doctor.md` | Human-readable command page for the watchtower-core doctor subcommand. |
...
| `docs/commands/core_python/watchtower_core_sync_coordination.md` | Human-readable command page for the watchtower-core sync coordination command. |
