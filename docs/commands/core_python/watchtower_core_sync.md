...
## Summary
This command group rebuilds derived governed artifacts or hosted-task mirrors from authored repository sources, including command lookup, reference lookup, planning indexes, planning trackers, coordination views, traceability, repository navigation surfaces, and GitHub task sync.
