...
## Summary
This command searches the governed initiative index so engineers and agents can see which phase a traced initiative is in, who is actively working on it, what is blocked, and what should happen next.

## Use When
- You want the cross-family start-here view for one initiative without opening PRDs, designs, plans, tasks, and traceability separately.
- You need to filter initiatives by phase, owner, status, or blockers.
- You want machine-readable initiative coordination data for a workflow, script, or agent.
