...
## Role
- This file applies to the [docs/references](/docs/references) subtree.
...
- Inherit [AGENTS.md](/AGENTS.md) and [docs/AGENTS.md](/docs/AGENTS.md) first and do not weaken them here.
...
- Use [reference_template.md](/docs/templates/reference_template.md) when creating new reference documents.
