...
| What link form should those files use? | Repository-native links such as `/docs/...`, `/core/workflows/...`, or `/plan/workflows/...` | Keeps the workflow portable across clones, branches, and worktrees instead of binding it to one machine path. |
