...
| `docs/planning/prds/structural_rewrite_program.md` | PRD for the guarded structural rewrite program through the Phase 4 shared-projection entry package and review gate. |
