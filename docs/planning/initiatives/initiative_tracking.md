...
|---|---|---|---|---|---|---|
| `trace.core_export_readiness_and_optimization` | `execution` | repository_maintainer | `4` | `docs/planning/prds/core_export_readiness_and_optimization.md` | `docs/planning/tasks/open/core_export_pack_interfaces.md` | Start or continue the active task set and keep the current task records aligned with execution progress. |
