...
|---|---|---|---|---|
| `trace.core_export_hardening_followup` | `completed` | `docs/planning/prds/core_export_hardening_followup.md` | `2026-03-10T17:12:30Z` | Implemented and validated export hardening follow-up. |
