...
|---|---|---|---|---|---|---|
| `trace.core_export_hardening_followup` | `execution` | repository_maintainer | `2` | `docs/planning/prds/core_export_hardening_followup.md` | `docs/planning/tasks/open/core_export_command_source_metadata.md` | Start or continue the active task set and keep the current task records aligned with execution progress. |
