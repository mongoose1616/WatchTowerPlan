...
| `trace.core_export_hardening_followup` | `active` | `docs/planning/design/implementation/core_export_hardening_execution.md` | Breaks the export-hardening follow-up into bounded slices for output-directory sync consistency, command metadata repair, and public boundary cleanup. | `docs/planning/design/features/core_export_hardening.md` | None |
