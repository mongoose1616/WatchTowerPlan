...
| `docs/planning/design/features/structural_rewrite_program.md` | Feature design for executing the guarded structural rewrite program through the first bounded Phase 3 command companion normalization slice and its outcome review. |
