...
| `docs/planning/design/features/structural_rewrite_program.md` | Feature design for executing rewrite Phase 0 and Phase 1, closing the Phase 2 gate, and delivering one bounded artifact-role metadata slice. |
