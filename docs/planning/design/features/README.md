...
| `docs/planning/design/features/structural_rewrite_program.md` | Feature design for executing the guarded structural rewrite program through the Phase 4 shared-projection entry package and review gate. |
