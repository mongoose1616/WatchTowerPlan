...
- [repository_standards_posture.md](/docs/foundations/repository_standards_posture.md): keep indexes, docs, and tests aligned as the boundary tightens.
- [product_direction.md](/docs/foundations/product_direction.md): hardening remains at the shared-substrate layer.

## Internal Standards and Canonical References Applied
- [engineering_best_practices_standard.md](/docs/standards/engineering/engineering_best_practices_standard.md): favor explicit boundaries, thin entrypoints, and targeted regression coverage.
- [command_index_standard.md](/docs/standards/data_contracts/command_index_standard.md): command metadata should remain trustworthy as a machine-readable navigation surface.
- [initiative_tracking_standard.md](/docs/standards/governance/initiative_tracking_standard.md): this work belongs to a new bounded initiative instead of reopening a closed trace.
