...
| `docs/planning/design/implementation/structural_rewrite_phase4_closeout_tracking_refresh_boundary.md` | Implementation plan for the bounded Phase 4 slice that routes the remaining closeout tracker refresh step through one private closeout-local boundary. |
| `docs/planning/design/implementation/structural_rewrite_program.md` | Implementation plan for the structural rewrite program through the closed closeout-tracking entry review and handoff into the bounded closeout-tracking refresh-boundary slice. |
