...
- [routing_and_context_loading_standard.md](/docs/standards/workflows/routing_and_context_loading_standard.md): constrains the route-preview behavior to stay deterministic and to use full prompt context rather than exact keyword matching alone.
- [route_index_standard.md](/docs/standards/data_contracts/route_index_standard.md): requires the route index to stay derived from the authored routing table and aligned in the same change set.
- [workflow_index_standard.md](/docs/standards/data_contracts/workflow_index_standard.md): constrains how workflow retrieval metadata and trigger tags should appear in the derived workflow index.
- [workflow_md_standard.md](/docs/standards/documentation/workflow_md_standard.md): preserves the distinct module boundaries that the discoverability fix must support rather than collapse.
