...
| --- | --- | --- | --- | --- | --- |
| [task.capture_first_plan_workspace_bootstrap.history_retention_reconciliation.007](/docs/planning/tasks/open/reconcile_legacy_history_and_retention_with_clean_endstate.md) | `backlog` | `high` | `repository_maintainer` | `trace.capture_first_plan_workspace_bootstrap` | Defines the follow-up tranche for historical docs handling, archive retention, and the clean-endstate purge policy after first-tranche cutover. |
...
| Task | Status | Priority | Owner | Trace ID | Summary |
| --- | --- | --- | --- | --- | --- |
| [task.capture_first_plan_workspace_bootstrap.cutover_proof_follow_up.006](/docs/planning/tasks/closed/archive/2026/03/17/cut_over_to_plan_entrypoints_and_prove_first_tranche_flows.md) | `done` | `high` | `repository_maintainer` | `trace.capture_first_plan_workspace_bootstrap` | Completes the hard cutover for new work, proves one pack-wide and one project-scoped flow, and records the history or retention follow-up tranche. |
| [task.capture_first_plan_workspace_bootstrap.project_scoped_flow.005](/docs/planning/tasks/closed/archive/2026/03/17/add_project_container_bootstrap_and_project_scoped_flow.md) | `done` | `high` | `repository_maintainer` | `trace.capture_first_plan_workspace_bootstrap` | Introduces the full project bootstrap package and proves the project-scoped initiative path. |
| [task.capture_first_plan_workspace_bootstrap.packwide_views_queries.004](/docs/planning/tasks/closed/archive/2026/03/17/add_packwide_rendered_views_queries_and_stale_surface_enforcement.md) | `done` | `high` | `repository_maintainer` | `trace.capture_first_plan_workspace_bootstrap` | Rebuilds pack-level and initiative-level visibility from the new authority model and fails closed on stale derived surfaces. |
...
| [task.plan_domain_pack_core_validation.core_suite_runtime.003](/docs/planning/tasks/closed/archive/2026/03/16/add_core_validation_suite_runtime_and_pack_contract_validation.md) | `done` | `high` | `repository_maintainer` | `trace.plan_domain_pack_core_validation` | Publishes the validation suite registry, reusable-core suite runtime, and pack-contract validator. |
