...
updated_at: "2026-03-10T20:42:00Z"
audience: "shared"
...
## Notes
- Added fail-closed repo-local Markdown-link validation for governed docs and workflow modules.
- Added targeted unit coverage for valid and invalid repo-local link targets plus the existing list-spacing rule.
