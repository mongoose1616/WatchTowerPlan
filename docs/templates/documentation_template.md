...
> If you keep front matter, align the keys and allowed values with [front_matter_standard.md](/docs/standards/metadata/front_matter_standard.md) and the matching document-family profile.
