...
> When `## Additional Files to Load` is present, keep it short, use repository-native Markdown links such as `/docs/...`, `/core/workflows/...`, `/plan/workflows/...`, or another concrete repo path, and write each bullet in `source: execution implication` form.
