# `docs/standards/metadata`

## Description
`This directory contains metadata standards for repository documents and structured planning artifacts. Use it for rules covering front matter, naming, identifiers, and shared terminology.`
