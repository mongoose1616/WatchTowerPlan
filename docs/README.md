...
## Description
`This directory contains repository-native documentation. Use it for durable guidance, product and design context, local references, standards, and reusable templates. Keep task execution procedures in workflows/ rather than embedding them here.`
...
| `docs/foundations/` | Holds product, philosophy, and repository-foundation documents. |
| `docs/planning/` | Holds PRDs, technical designs, implementation plans, and durable decision records. |
