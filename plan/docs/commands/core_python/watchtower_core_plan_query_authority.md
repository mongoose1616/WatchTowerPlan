...
| `watchtower-core plan query initiatives` | Focused initiative-family lookup surface that the authority map may point to for history or compact phase browsing. |
