...
- [git_workflow_standard.md](/core/docs/standards/engineering/git_workflow_standard.md): local branch creation, naming, and sync behavior should stay separate from hosted collaboration rules.
- [github_task_sync_standard.md](/plan/docs/standards/governance/github_task_sync_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
