...
- [github_collaboration_standard.md](/plan/docs/standards/governance/github_collaboration_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
- [task_index_standard.md](/plan/docs/standards/data_contracts/task_index_standard.md): companion standard that constrains this standard's boundary, validation, or change-control expectations.
...
- [github_collaboration_reference.md](/core/docs/references/github_collaboration_reference.md): local reference surface for the external or canonical guidance this standard depends on.
...
- Update the live task-state writers, task index schema, task sync command docs, and implementation surfaces in the same change set when this sync contract changes structurally.
...
- [github_collaboration_reference.md](/core/docs/references/github_collaboration_reference.md)
