...
- `Operational Surfaces`: `core/workflows/modules/documentation_refresh.md`; `core/workflows/modules/reference_distillation.md`; `core/workflows/modules/documentation_generation.md`; `core/docs/templates/reference_template.md`
...
- [diataxis_local_reference.md](/core/docs/references/diataxis_local_reference.md)
