...
| `plan/docs/standards/governance/rewrite_execution_control_standard.md` | Defines the parity contract, slice-control package, and checkpoint workflow for the structural rewrite program. |
