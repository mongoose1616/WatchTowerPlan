...
summary: "This standard defines the shared baseline for live plan-related derived index standards stored under `core/control_plane/indexes/` and `plan/.wt/indexes/`."
type: "standard"
status: "active"
tags:
  - "standard"
...
## Summary
This standard defines the shared baseline for live plan-related derived index standards stored under `core/control_plane/indexes/` and `plan/.wt/indexes/`.
...
## Scope
- Applies to the live plan-related derived index standards for coordination, initiatives, tasks, and traceability.
...
- [standard_md_standard.md](/core/docs/standards/documentation/standard_md_standard.md): keeps the shared baseline pattern explicit and section-complete instead of turning the member standards into vague stubs.
- [standard_index_standard.md](/core/docs/standards/data_contracts/standard_index_standard.md): requires the family baseline and member standards to stay queryable through the governed standard index.
- [compact_document_authoring_standard.md](/core/docs/standards/documentation/compact_document_authoring_standard.md): supports reducing repeated boilerplate only when the remaining member-standard deltas stay readable and reviewable.
- [repository_standards_posture.md](/core/docs/foundations/repository_standards_posture.md): requires companion human-readable and machine-readable surfaces to move together when this family changes.
...
- `Operational Surfaces`: `plan/docs/standards/data_contracts/planning_index_family_standard.md`; `plan/docs/standards/data_contracts/coordination_index_standard.md`; `plan/docs/standards/data_contracts/initiative_index_standard.md`; `plan/docs/standards/data_contracts/task_index_standard.md`; `plan/docs/standards/data_contracts/traceability_index_standard.md`; `core/docs/standards/data_contracts/README.md`; `core/control_plane/indexes/standards/README.md`; `core/control_plane/indexes/standards/standard_index.json`; `core/docs/commands/core_python/watchtower_core_query_standards.md`
...
- Update the affected member standards, `core/docs/standards/README.md`, `plan/docs/standards/**`, `core/docs/standards/data_contracts/README.md`, the governed standard index, the `watchtower-core query standards` command page, and the direct regression tests in the same change set when family membership or family-wide discoverability changes.

## References
- [standard_md_standard.md](/core/docs/standards/documentation/standard_md_standard.md)
- [standard_index_standard.md](/core/docs/standards/data_contracts/standard_index_standard.md)
- [README.md](/core/docs/standards/data_contracts/README.md)
