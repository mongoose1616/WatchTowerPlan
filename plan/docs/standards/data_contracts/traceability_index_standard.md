...
- [planning_index_family_standard.md](/plan/docs/standards/data_contracts/planning_index_family_standard.md): defines the shared derived-index baseline and discoverability contract this traceability-family standard narrows.
