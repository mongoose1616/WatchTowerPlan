...
- Root router surfaces may point humans toward `plan/**`, but they must not stop acknowledging the current canonical routing backend at `core/workflows/ROUTING_TABLE.md` and `plan/workflows/ROUTING_TABLE.md`.
