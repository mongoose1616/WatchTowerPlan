...
- Do not attempt the full workflow-root split in this slice; `core/workflows/ROUTING_TABLE.md` and `plan/workflows/ROUTING_TABLE.md` and the existing workflow modules remain the operative routing backend until a later migration tranche lands.
