...
- Hard-cut planning terminology and phase vocabulary: Replace retired PRD/design/implementation-plan language and stale initiative phase names on active surfaces with the initiative-package model.
...
- Replace retired planning-document semantics: Remove the remaining PRD and implementation-plan semantic helpers and validate only the live initiative-package authored inputs.
