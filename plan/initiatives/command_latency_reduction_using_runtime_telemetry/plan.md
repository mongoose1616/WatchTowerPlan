...
- `updated_at`: `2026-03-22T18:57:43Z`
...
| --- | --- | --- | --- | --- | --- |
| [task.command_latency_reduction_using_runtime_telemetry.capture_latency_baseline_and_hotspot_inventory](/plan/initiatives/command_latency_reduction_using_runtime_telemetry/.wt/tasks/capture_latency_baseline_and_hotspot_inventory/task.json) | `ready` | `high` | `repository_maintainer` | Profiles the agreed command set and turns the telemetry evidence into a ranked hotspot inventory. | - |
...
| [task.command_latency_reduction_using_runtime_telemetry.reduce_plan_command_latency](/plan/initiatives/command_latency_reduction_using_runtime_telemetry/.wt/tasks/reduce_plan_command_latency/task.json) | `planned` | `high` | `repository_maintainer` | Uses the telemetry baseline to reduce avoidable latency in plan sync, query, task, and closeout command paths. | task.command_latency_reduction_using_runtime_telemetry.capture_latency_baseline_and_hotspot_inventory |
