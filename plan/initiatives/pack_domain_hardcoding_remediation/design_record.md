...
- `watchtower_core.control_plane` is the reusable pack-agnostic contract and loader boundary. It is not a duplicate of `watchtower_plan`, which is now the approved plan-owned runtime boundary under `plan/python/src/watchtower_plan/`.
