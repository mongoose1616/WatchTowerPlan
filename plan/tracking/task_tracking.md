...
| --- | --- | --- | --- | --- | --- |
| [task.watchtower_ctf_implementation_package_preservation.phase_2_pack_machine_contract](/plan/projects/watchtower/initiatives/watchtower_ctf_implementation_package_preservation/.wt/tasks/phase_2_pack_machine_contract/task.json) | `in_progress` | `high` | `repository_maintainer` | `trace.watchtower_ctf_implementation_package_preservation` | Author the offsec schemas, registries, policies, validation suite, and human-surface starter contract. |
...
_Updated At: `2026-03-28T03:56:49Z`_
