...
| Open First | [plan/initiatives/core_host_pack_architecture_hard_cutover/plan.md](/plan/initiatives/core_host_pack_architecture_hard_cutover/plan.md) |
...
| --- | --- | --- | --- | --- |
| `trace.core_host_pack_architecture_hard_cutover` | `execution` | repository_maintainer | [plan.md](/plan/initiatives/core_host_pack_architecture_hard_cutover/plan.md) | Advance the current in-progress task set and keep initiative-local task state current. |
...
_Updated At: `2026-03-20T18:10:17Z`_
