...
| --- | --- | --- | --- | --- |
| `trace.core_host_pack_architecture_hard_cutover` | `execution` | repository_maintainer | [plan.md](/plan/initiatives/core_host_pack_architecture_hard_cutover/plan.md) | Promote the next planned task to ready before opening follow-up work. |
