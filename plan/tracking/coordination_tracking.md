...
| --- | --- | --- | --- | --- |
| `trace.domain_pack_externalization_portability_proof` | `execution` | repository_maintainer | [plan.md](/plan/initiatives/domain_pack_externalization_portability_proof/plan.md) | Promote the next planned task to ready before opening follow-up work. |
