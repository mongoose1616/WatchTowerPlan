...
REMOVED_TEST_PATHS = (
    ...
    REPO_ROOT / "core/python/tests/integration/test_control_plane_artifact_schema_contracts.py",
    (
        REPO_ROOT
        / "core/python/tests/integration/test_control_plane_loader_and_foundation_contracts.py"
    ),
    REPO_ROOT / "core/python/tests/integration/test_endstate_cutover_guards.py",
    ...
    REPO_ROOT / "core/python/tests/unit/test_actor_registry_helper.py",
    REPO_ROOT / "core/python/tests/unit/test_artifact_family.py",
    REPO_ROOT / "core/python/tests/unit/test_cli_knowledge_query_commands.py",
    REPO_ROOT / "core/python/tests/unit/test_command_index_sync.py",
    ...
    REPO_ROOT / "core/python/tests/unit/test_discrepancy_helper.py",
    REPO_ROOT / "core/python/tests/unit/test_documentation_family.py",
    REPO_ROOT / "core/python/tests/unit/test_event_stream_helper.py",
    REPO_ROOT / "core/python/tests/unit/test_human_surface_policy.py",
    ...
    REPO_ROOT / "core/python/tests/unit/test_planning_vocabulary.py",
    REPO_ROOT / "core/python/tests/unit/test_project_surface_policy.py",
    REPO_ROOT / "core/python/tests/unit/test_project_query_handlers.py",
    REPO_ROOT / "core/python/tests/unit/test_promotion_policy.py",
    REPO_ROOT / "core/python/tests/unit/test_query_harness.py",
    REPO_ROOT / "core/python/tests/unit/test_retention_policy.py",
    REPO_ROOT / "core/python/tests/unit/test_template_catalog.py",
    REPO_ROOT / "core/python/tests/unit/test_terminology_helper.py",
