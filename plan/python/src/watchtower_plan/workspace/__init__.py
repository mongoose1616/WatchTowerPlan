...
_EXPORT_MODULES = {
    ...
    "PLAN_COORDINATION_INDEX_PATH": "watchtower_plan.workspace.constants",
    "PLAN_PACK_SETTINGS_PATH": "watchtower_plan.workspace.constants",
    "PLAN_REVIEW_INDEX_PATH": "watchtower_plan.workspace.constants",
    "PLAN_TASK_INDEX_PATH": "watchtower_plan.workspace.constants",
    "PlanTaskIndexEntry": "watchtower_plan.workspace.models",
