...
_EXPORT_MODULES = {
    ...
    "TaskCreateParams": "watchtower_plan.tasks.models",
    "TaskLifecycleService": "watchtower_plan.tasks.lifecycle",
    "TaskMutationResult": "watchtower_plan.tasks.models",
    "TaskTransitionParams": "watchtower_plan.tasks.models",
    "TaskUpdateParams": "watchtower_plan.tasks.models",
