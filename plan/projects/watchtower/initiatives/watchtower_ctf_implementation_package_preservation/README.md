...
| `conditional_revisit_queue.md`, `contradiction_sweep_ledger.md` | Ambiguity control surfaces | You need to know what stays deferred and what is already reconciled. |
