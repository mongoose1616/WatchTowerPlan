...
- [watchtower_core_plan_closeout_retained_initiative.md](/plan/docs/commands/core_python/watchtower_core_plan_closeout_retained_initiative.md): documents the retained-trace closeout command that performs the closeout mutation and derived-surface rebuild.
