...
- [task_lifecycle_management.md](/plan/workflows/modules/task_lifecycle_management.md): GitHub sync writes local task metadata and must leave the authoritative task corpus aligned afterward.
