...
- [task_tracking_standard.md](/docs/standards/governance/task_tracking_standard.md): initiative-local live task state remains authoritative even when GitHub mirrors exist.
